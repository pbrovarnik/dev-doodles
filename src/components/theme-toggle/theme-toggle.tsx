...
const setAriaLabel = (target: HTMLInputElement) => {
	const themeToggleParent = target.parentElement?.parentElement;
	themeToggleParent?.setAttribute('aria-label', `Switch to ${target.checked ? 'light' : 'dark'} theme`);
};
...
export default function ThemeToggle() {
	...
	return (
		<div id="themeToggle" className="theme-toggle">
			<label>
